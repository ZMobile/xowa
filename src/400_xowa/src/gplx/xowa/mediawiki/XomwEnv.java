...
import gplx.xowa.mediawiki.includes.XomwMagicWordMgr;
import gplx.xowa.mediawiki.includes.XomwMediaWikiServices;
import gplx.xowa.mediawiki.includes.XomwMessageMgr;
import gplx.xowa.mediawiki.includes.filerepo.file.XomwFileFinder;
import gplx.xowa.mediawiki.includes.filerepo.file.XomwFileFinderNoop;
import gplx.xowa.mediawiki.includes.interwiki.XomwInterwikiLookup;
import gplx.xowa.mediawiki.includes.interwiki.XomwInterwikiLookupAdapter;
import gplx.xowa.mediawiki.includes.media.XomwMediaHandlerFactory;
import gplx.xowa.mediawiki.includes.site.XomwSiteLookup;
import gplx.xowa.mediawiki.includes.site.XomwXowaSiteLookup;

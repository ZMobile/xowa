 ...
 * @since 1.17
 */
class XomwMessage { // implements MessageSpecifier, Serializable
	/** Use message text as-is */
	static final String FORMAT_PLAIN = "plain";
	/** Use normal wikitext . HTML parsing (the result will be wrapped in a block-level HTML tag) */
	static final String FORMAT_BLOCK_PARSE = "block-parse";
	/** Use normal wikitext . HTML parsing but strip the block-level wrapper */
	static final String FORMAT_PARSE = "parse";
	/** Transform {{..}} constructs but don't transform to HTML */
	static final String FORMAT_TEXT = "text";
	/** Transform {{..}} constructs, HTML-escape the result */
	static final String FORMAT_ESCAPED = "escaped";
	
	/**
	 * Mapping from Message::listParam() types to Language methods.
	 * @var array
	 */
	protected static XophpArray listTypeMap = XophpArray.New()
		.Add("comma", "commaList")
		.Add("semicolon", "semicolonList")
		.Add("pipe", "pipeList")
		.Add("text", "listToText")
		;
	 ...
	 * @var bool
	 */
	protected boolean interface_var = true;
	 ...
	 */
	protected XomwLanguage language = null;
	 ...
	 */
	protected XophpArray keysToTry;

	/**
	 * @var array List of parameters which will be substituted into the message.
	 */
	protected XophpArray parameters = XophpArray.New();

	/**
	 * @var string
	 * @deprecated
	 */
	protected String format = "parse";
	 ...
	 */
	protected XomwTitle title = null;

	/**
	 * @var Content Content object representing the message.
	 */
	protected XomwContent content = null;
	 ...
	 */
	public XomwMessage(String key) {this(key, XophpArray.New(), null);}
	public XomwMessage(Object key, XophpArray params, XomwLanguage language) {
//		if ($key instanceof MessageSpecifier) {
//			if ($params) {
//				throw new XomwInvalidArgumentException(
...
//		}
		...
		if (XophpString_.is_string(key)) {
			...
			throw new XophpInvalidArgumentException("{0} must be a string or an array", key);
		}
		// XOMW.TYPE.END

...
//		}
	...
	* @return ContentHandler
	*/
	public static XomwContentHandler getForContent(XomwContent content) {
		int modelId = content.getModel();

		return XomwContentHandler.getForModelID(modelId);
	}

	/**
	* @var array A Cache of ContentHandler instances by model id
	*/
	private static XomwContentHandler[] handlers = new XomwContentHandler[XomwDefaultSettings.CONTENT_MODEL__MAX];
	...
	*/
	public static XomwContentHandler getForModelID(int modelId) {
		XomwContentHandler handler = XomwContentHandler.handlers[modelId];
		if (handler != null) {
			return handler;
		}

		// XOMW.PORTED
		//   MW does reflection-based instantiation using wgContentHandlers
		//   XO does hard-coded instantiation			
		switch (modelId) {
			case XomwDefaultSettings.CONTENT_MODEL_WIKITEXT:        handler = new XomwWikitextContentHandler(); break;
//				case XomwDefaultSettings.CONTENT_MODEL_JAVASCRIPT:      handler = new XomwWikitextContentHandler(); break;
...
//		// ------------------------------------------------------------------------
	...
	*/
	public XomwContentHandler(int modelId, String... formats) {
...
//		}
	...
	*/
	public boolean isSupportedFormat(String format) {
		...
		return mSupportedFormatsHash.Has(format);
	}

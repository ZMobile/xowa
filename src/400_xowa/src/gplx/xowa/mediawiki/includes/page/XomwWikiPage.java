 ...
 */
public class XomwWikiPage { // implements Page, IDBAccessObject
...
//
	...
	public static XomwWikiPage factory(XomwTitle title) {
		...
		if (ns == XomwDefines.NS_MEDIA) {
			throw new XomwMWException("NS_MEDIA is a virtual namespace; use NS_FILE.");
		} else if (ns < 0) {
			throw new XomwMWException("Invalid or virtual namespace {0} given.", ns);
		}

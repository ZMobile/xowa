...
//		}
	...
	* @return Message this
	*/
	public XomwMessageOld rawParams(byte[]... prmsAry) {
		for (byte[] prmsVar : prmsAry) {
			this.parameters.Add(XomwMessageOld.rawParam(prmsVar));
		}
		return this;
	}
	...
	* @return Message this
	*/
	public XomwMessageOld numParams(int... prmsAry) {
		for (int prmsVar : prmsAry) {
			this.parameters.Add(XomwMessageOld.numParam(prmsVar));
		}
		return this;
	}
	...
	* @return Message this
	*/
	public XomwMessageOld durationParams(int... prmsAry) {
		for (int prmsVar : prmsAry) {
			this.parameters.Add(XomwMessageOld.durationParam(prmsVar));
		}
		return this;
	}
	...
	* @return Message this
	*/
	public XomwMessageOld expiryParams(byte[]... prmsAry) {
		for (byte[] prmsVar : prmsAry) {
			this.parameters.Add(XomwMessageOld.expiryParam(prmsVar));
		}
		return this;
	}
	...
	* @return Message this
	*/
	public XomwMessageOld timeperiodParams(int... prmsAry) {
		for (int prmsVar : prmsAry) {
			this.parameters.Add(XomwMessageOld.timeperiodParam(prmsVar));
		}
		return this;
	}
	...
	* @return Message this
	*/
	public XomwMessageOld sizeParams(int... prmsAry) {
		for (int prmsVar : prmsAry) {
			this.parameters.Add(XomwMessageOld.sizeParam(prmsVar));
		}
		return this;
	}
	...
	* @return Message this
	*/
	public XomwMessageOld bitrateParams(int... prmsAry) {
		for (int prmsVar : prmsAry) {
			this.parameters.Add(XomwMessageOld.bitrateParam(prmsVar));
		}
		return this;
	}
	...
	* @return Message this
	*/
	public XomwMessageOld plaintextParams(byte[]... prmsAry) {
		for (byte[] prmsVar : prmsAry) {
			this.parameters.Add(XomwMessageOld.plaintextParam(prmsVar));
		}
		return this;
	}
...
//		}
	...
	* @return Message this
	*/
	public XomwMessageOld inContentLanguage() {
...
//		}
	...
	*/
	public byte[] textMw() {
		this.format = XomwMessageOld.FORMAT_TEXT;
		return this.toString(XomwMessageOld.FORMAT_TEXT);
	}

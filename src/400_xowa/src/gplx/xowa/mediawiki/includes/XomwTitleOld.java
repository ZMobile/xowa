...
//
//		/**
//		* @var boolean|String ID of the page's content model, i.e. one of the
//		*   CONTENT_MODEL_XXX constants
//		*/
//		private $mContentModel = false;
//
//		/**
//		* @var boolean If a content model was forced via setContentModel()
...
//
//		/** @var boolean Cascade restrictions on this page to included templates and images? */
...
//
//		/** @var boolean Are cascading restrictions in effect on this page? */
...
//
//		/** @var boolean Whether a page has any subpages */
//		private $mHasSubpages;
//
//		/** @var boolean The (String) language code of the page's language and content code. */
...
//		}
	...
	* @return Title
	*/
	private static XomwTitleOld newFromTextThrow(XomwEnv env, byte[] text, int defaultNamespace) {
		// if (is_object($text)) {
...
//		}
		...
		* @return Title|null The new Object, or null on an error
		*/
		public static XomwTitleOld newFromID(int id) {return newFromID(id, 0);}
		public static XomwTitleOld newFromID(int id, int flags) {
...
//		*
//		* @param stdClass|boolean $row Database row
//		*/
...
//		* @param String $fragment The link fragment (after the "#")
//		* @param String $interwiki The interwiki prefix
//		* @param boolean $canonicalNamespace If true, use the canonical name for
...
//		}
	...
	* @return Title
	*/
	public XomwTitleOld createFragmentTarget(byte[] fragment) {
		return null;
//			return self::makeTitle(
//				this.getNamespace(),
//				this.getText(),
...
//
//		/**
//		* Get the super page name title, i.e. the part before the subpage name
//		*
//		* @par Example:
//		* @code
...
//		* @param String|String[]|boolean $query2
//		* @return String
//		*/
...
//		}
	...
	* @param String|String[]|boolean $query2 An optional secondary query array. This one MUST
...
//					}
//				}
			// XO.MW.HOOK:GetLocalURL::Internal
//
...
//		* @param String $rigor Same format as Title::getUserPermissionsErrors()
//		* @param boolean $short Short circuit on first error
//		*
...
//		* @param boolean $exists True to get all restriction types that apply to
...
//		*
//		* @return array|boolean An associative array representing any existent title
...
//		* the database.
//		*
//		* @param boolean $getPages True to check if the pages are loaded, or false to check
//		* if the status is loaded.
//		* @return boolean Whether or not the specified information has been loaded
//		* @since 1.23
//		*/
...
//		*
//		* @param boolean $getPages Whether or not to retrieve the actual pages
...
//		*
//		* @return boolean Whether or not the page's restrictions have already been
...
//		*
//		* @param String $action
//		* @return String|boolean 14-char timestamp, or 'infinity' if the page is protected forever
...
//		}
		...
		* @return int The ID
		*/
		public int getArticleID() {return getArticleID(0);}
		public int getArticleID(int flags) {
			if (this.getNamespace() < 0) {
				this.mArticleID = 0;
...
//		* @param boolean $auth Whether to check user permissions (uses $wgUser)
...
//		* @param Title $nt The new title
//		* @param boolean $auth Indicates whether $wgUser's permissions
//		*  should be checked
//		* @param String $reason The reason for the move
//		* @param boolean $createRedirect Whether to create a redirect from the old title to the new title.
...
//		* @param boolean $auth Whether $wgUser's permissions should be checked
//		* @param String $reason The reason for the move
//		* @param boolean $createRedirect Whether to create redirects from the old subpages to
...
//		* Adds synchronized, so don't use just for light purposes.
//		*
//		* @return boolean
//		*/
...
//		* @return int|boolean Old revision ID, or false if none exists
//		*/
...
//		* @param int $flags Title::GAID_FOR_UPDATE
//		* @return int|boolean Next revision ID, or false if none exists
//		*/

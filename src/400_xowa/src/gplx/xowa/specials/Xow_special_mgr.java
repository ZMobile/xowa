...
import gplx.xowa.mediawiki.extensions.Wikibase.repo.includes.specials.Wbase_entityPage;
import gplx.xowa.specials.allPages.Xows_page_allpages;
import gplx.xowa.specials.mgrs.Xoa_special_regy;
import gplx.xowa.specials.movePage.Move_page;
import gplx.xowa.specials.nearby.Nearby_mgr;
import gplx.xowa.specials.statistics.Xop_statistics_page;
import gplx.xowa.specials.xowa.default_tab.Default_tab_page;
import gplx.xowa.specials.xowa.diags.Xows_diag_page;
import gplx.xowa.specials.xowa.errors.Xoerror_special;
import gplx.xowa.specials.xowa.popup_history.Popup_history_page;
import gplx.xowa.specials.xowa.system_data.System_data_page;
import gplx.xowa.users.bmks.Xows_bmk_page;
import gplx.xowa.users.history.Xou_history_html;
import gplx.xowa.users.history.Xou_history_mgr;
import gplx.xowa.users.history.Xoud_history_special;
import gplx.xowa.wikis.pages.Xopage_html_data;
import gplx.xowa.xtns.translates.Xop_mylanguage_page;
import gplx.xowa.xtns.wbases.specials.Wdata_itemByTitle_page;

...
, Id_zu = 485
	;
	public static final int Id__max = 486;
...
Regy_add(stub_hash, Id_abs, "abs", "Ambonese Malay");
...
Regy_add(stub_hash, Id_ais, "ais", "Asturian");
...
Regy_add(stub_hash, Id_ami, "ami", "Amis");
...
Regy_add(stub_hash, Id_as, "as", "অসমীয়া");
...
Regy_add(stub_hash, Id_btm, "btm", "Mandailing");
...
Regy_add(stub_hash, Id_cak, "cak", "Kaqchikel");
...
Regy_add(stub_hash, Id_cop, "cop", "Coptic");
...
Regy_add(stub_hash, Id_din, "din", "Dinka");
...
Regy_add(stub_hash, Id_fon, "fon", "Fon");
...
Regy_add(stub_hash, Id_gaa, "gaa", "Gaa");
...
Regy_add(stub_hash, Id_gcf, "gcf", "Guadeloupean Creole French");
Regy_add(stub_hash, Id_gcr, "gcr", "Guianan Creole");
...
Regy_add(stub_hash, Id_hne, "hne", "Chhattisgarhi ");
Regy_add(stub_hash, Id_ho, "ho", "Hiri Motu");
Regy_add(stub_hash, Id_hoc, "hoc", "Ho");
...
Regy_add(stub_hash, Id_hyw, "hyw", "Western Armenian");
...
Regy_add(stub_hash, Id_ksw, "ksw", "Kofa");
...
Regy_add(stub_hash, Id_kum, "kum", "Kumyk");
...
Regy_add(stub_hash, Id_lag, "lag", "Rangi");
...
Regy_add(stub_hash, Id_lkt, "lkt", "Lakota");
Regy_add(stub_hash, Id_lld, "lld", "Ladin");
...
Regy_add(stub_hash, Id_mni, "mni", "Manipuri/Meitei");
Regy_add(stub_hash, Id_mnw, "mnw", "Mon");
...
Regy_add(stub_hash, Id_nqo, "nqo", "N'Ko");
...
Regy_add(stub_hash, Id_prs, "prs", "Dari");
...
Regy_add(stub_hash, Id_qwh, "qwh", "Huaylas Quechua");
...
Regy_add(stub_hash, Id_shy_latn, "shy-latn", "Shawiya - Latin");
...
Regy_add(stub_hash, Id_skr, "skr", "Saraiki");
Regy_add(stub_hash, Id_skr_arab, "skr-arab", "Saraiki - Arabic");
...
Regy_add(stub_hash, Id_sty, "sty", "Siberian Tatar");
...
Regy_add(stub_hash, Id_tay, "tay", "Atayal");
...
Regy_add(stub_hash, Id_trv, "trv", "Seediq");
...
Regy_add(stub_hash, Id_xsy, "xsy", "Saisiyat");
...
Regy_add(stub_hash, Id_zgh, "zgh", "Moroccan Amazigh");
